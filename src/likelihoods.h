...
extern BOOL   *bAllowed_parents;     /* parents allowed for each node? y/n */
...
extern double extra_df_wishart;      /* extra Wishart degrees of freedom */
extern double scale_wishart_diag;    /* diag elems of Wishart scale */
extern double scale_wishart_offdiag; /* off-diag elems of Wishart scale */
extern int    maximum_scc_size;

extern int    nData;               /* max number of data points per node */
extern int    *pDataLevels;        /* num. of codes per node if discrete data */
